...
<section class="navigation-profile__section --flex-column-left  --gap-normal">
    ...
    <nav class="navigation-profile__nav --flex-column-left">
        ...
        <a href="<%= ApplicationConfiguration.getPath("app.root", "dir.views", "dir.users", "view.profile") %>?section=create-product" class="<%= PermissionService.can(request.getSession(false), Permission.POSTS_HANDLE) ? "--show" : "--hidden" %> navigation-profile__option --flex-center --gap-normal">
            <span class="navigation-profile__icon">
                <svg  xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                      fill="currentColor" viewBox="0 0 24 24" >
                    <!--Boxicons v3.0.8 https://boxicons.com | License  https://docs.boxicons.com/free-->

    ...
    <div class="content-spacing">
        <div class="header-main__content --flex-space-between">
            <a class="header-main__link --flex-center --gap-narrowly" href="<%= ApplicationConfiguration.getProperty("view.home") %>">
                ...
                <span>Touch Market</span>
            </a>
            <form class="header-main__search --flex-center  --search-form">
                ...
                <input class="header-main__input --search-input" type="search" placeholder="Search">
                <button type="submit" class="header-main__button --button">Search</button>
            </form>
            <div class="header-main__user --flex-center">
                ...
                <a href="<%= ApplicationConfiguration.getPath("app.root", "servlet.user.login") %>" class="header-main__icon --padding-inline-narrowly --flex-center">

...
<section class="footer-top --flex-center">
    <div class="content-spacing">
        <div class="footer-top__content --flex-space-between --gap-large --padding-block-normal">
            <div class="footer-top__logo --flex-center --gap-narrowly" href="http://">
                ...
                <span class="footer-top__title">Plantation</span>
            </div>

            <div class="footer-top__news">
                <h2 class="footer-news__title">Subscribe our Newsletter</h2>
                <p class="footer-news__paragraph">Suscribete para recibir notificaciones sobre ofertas precios y mucho mas</p>
            </div>

            <form class="footer-top__form --newsletter-form --flex-space-between">
                <input class="footer-form__input --newsletter-input --padding-inline-normal --padding-block-narrowly" type="email" name="email" placeholder="Your email address" required>
                <button class="footer-form__button --newsletter-button --padding-inline-normal" type="submit">Subscribe</button>
            </form>
        </div>
    </div>
</section>
